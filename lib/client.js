window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/** Plugin version stamp: shown in the card footer so the loaded bundle is identifiable. */
		...
		*/
		var FailoverContinueCardModel = class {
			...
			project() {
				...
				return {
					...
					locale: typeof this.shown("locale") === "string" && this.shown("locale").trim() !== "" ? this.shown("locale") : "ru",
		...
		function HealthTable(props) {
			...
			(0, react.useEffect)(() => {
				let live = true;
				fetch("/api/failover-continue/status").then((response) => response.json()).then((body) => {
					if (!live || body?.ok !== true || body.data === void 0) return;
					setSnapshot({
			...
			const t = props.t;
			if (snapshot === null) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
				className: FailoverContinueCard_module_css_default.hint,
				children: t("healthUnavailable")
			});
			const probes = new Map(snapshot.doctor.results.map((r) => [`${r.provider}${r.model}`, r]));
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: snapshot.health.map((row) => {
				const probe = probes.get(`${row.provider}${row.model}`);
				const state = row.open ? `${t("stateOpen")} ${Math.max(0, Math.round(row.remainingMs / 1e3))}s` : probe === void 0 ? t("stateOk") : probe.ok ? `${t("stateOk")} ${probe.latencyMs}ms` : `${probe.code ?? "FAIL"}: ${probe.error ?? ""}`;
		...
		*/
		function FailoverContinueCard({ t: hostT, useCard, ...actions }) {
			...
			if (!state.available) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: hostT("loading")
				})
			});
			const dict = state.locale === "en" ? en : ru;
			const t = (key) => dict[key] ?? en[key];
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: FailoverContinueCard_module_css_default.label,
									children: t("doctorSection")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: FailoverContinueCard_module_css_default.hint,
									children: t("doctorSectionHint")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(HealthTable, { t })
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: FailoverContinueCard_module_css_default.row,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: FailoverContinueCard_module_css_default.label,
								children: t("idleWatch")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: FailoverContinueCard_module_css_default.hint,
								children: t("idleWatchHint")
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: FailoverContinueCard_module_css_default.row,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
							className: FailoverContinueCard_module_css_default.footNote,
							children: ["dsh-failover-continue ", PLUGIN_VERSION]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		function apply(ctx) {
			...
			try {
				...
				console.error("[dsh-failover-continue] card registration failed:", error instanceof Error ? error.message : String(error));
			}
		}
		//#endregion
		exports.apply = apply;
